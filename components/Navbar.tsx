  ...
  return (
    <Element
      ...
      className="overflow-visible rounded-[6px] top-5  sticky md:mx-auto z-50 
        ...
        py-1.5 md:py-2.5 px-3 md:px-6 mx-3 shadow-lg md:shadow-xl"
    >
      ...
      <Link
        href="/"
        className="md:justify-left justify-self-start translate-x-0.5 md:translate-x-0 md:ml-4"
      >
        <Image
          ...
          width={1000}
          height={1000}
          className="w-16 md:w-20 scale-140 md:scale-145 -my-0.5 md:-my-1"
        />
      </Link>

      {/* Desktop Navigation - Center */}
      <div className="hidden md:flex justify-self-center gap-x-6 items-center text-gray-700 font-semibold text-base -ml-22">
        <Link
          href="/showcase"
      ...
      <div className="flex items-center gap-x-3 justify-self-end md:mr-4 font-semibold">
        ...
        <Link
          href="/meeting"
          className="md:py-2 md:px-4 md:text-sm py-2 px-3 text-sm
